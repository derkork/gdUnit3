...
func test_before(test_suite :GdUnitTestSuiteDelegator, test_case :Node) -> GDScriptFunctionState:
...
func test_after(test_suite :GdUnitTestSuiteDelegator, test_case :Node) -> GDScriptFunctionState:
...
func execute_test_case(test_suite :GdUnitTestSuiteDelegator, test_case :Node) -> GDScriptFunctionState:
